...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    ERM_PROFILE=gcp \
    ERM_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m rcsa_kri_erm.managed_readiness && exec uvicorn rcsa_kri_erm.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
