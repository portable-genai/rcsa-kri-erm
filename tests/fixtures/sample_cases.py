...
#: An RCSA control id carrying both planted identifiers. The ERM service builds its citation
#: locator as ``control:<control_id>``, so a control id sourced from a client naming convention
#: (an owner's address, a subject's national id) reaches the WORM record through that field.
PII_CONTROL_ID = f"CTL-{PLANTED_NRIC}-OWNED-BY-{PLANTED_EMAIL}"
