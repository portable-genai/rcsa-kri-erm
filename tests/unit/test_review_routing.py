...
from rcsa_kri_erm.adapters.gcp.review_router import (
    CloudReviewRouter,
)
from rcsa_kri_erm.adapters.local.review_router import (
    LocalReviewRouter,
)
from rcsa_kri_erm.adapters.onprem.review_router import (
    OnPremReviewRouter,
)
