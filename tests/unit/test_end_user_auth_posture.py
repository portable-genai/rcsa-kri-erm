...
read
    ...
    bind_profile == local AND profile chosen AND ERM_S2S_TOKEN unset
...
from rcsa_kri_erm.adapters.local.identity import (
    LocalIdentityAdapter,
)
from rcsa_kri_erm.adapters.onprem.identity import (
