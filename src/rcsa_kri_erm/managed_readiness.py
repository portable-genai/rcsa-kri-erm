...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "control_library.CloudControlLibraryAdapter.get_control",
    "control_library.CloudControlLibraryAdapter.list_controls",
    "metric_feed.CloudMetricFeedAdapter.fetch",
    "theme_feed.CloudThemeFeedAdapter.themes",
)
